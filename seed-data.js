...
/* ===================== LESSON 26 ===================== */
{
  lessonNum: 26,
  topic: "〜んです・〜ていただけませんか",
  topicEn: "Объяснительное んです & Вежливые просьбы",
  module: 'L26', moduleLabel: 'L26 — Объяснительное んです & Просьбы', lesson: 'L26', lessonLabel: 'Объяснительное んです & Просьбы',
  difficulty: "hard",
  level: "N4",
  vocabulary: [
    { id: "L26v1", word: "約束", reading: "やくそく", pitch: 0, meaning: "обещание; договорённость", example: "友達と約束があるんです。", exampleMeaning: "У меня договорённость с подругой." },
    { id: "L26v2", word: "都合", reading: "つごう", pitch: 0, meaning: "удобство; наличие времени", example: "あした都合が悪いんです。", exampleMeaning: "Завтра мне неудобно." },
    { id: "L26v3", word: "直します", reading: "なおします", pitch: 4, meaning: "починить; исправить", example: "この時計を直していただけませんか。", exampleMeaning: "Не могли бы вы починить эти часы?" },
    { id: "L26v4", word: "故障します", reading: "こしょうします", pitch: 0, meaning: "сломаться (о технике)", example: "エアコンが故障したんです。", exampleMeaning: "Кондиционер сломался." },
    { id: "L26v5", word: "動きます", reading: "うごきます", pitch: 4, meaning: "двигаться; работать (о технике)", example: "パソコンが動かないんです。", exampleMeaning: "Мой компьютер не работает." },
    { id: "L26v6", word: "込みます", reading: "こみます", pitch: 2, meaning: "быть переполненным", example: "電車が込んでいて、遅れたんです。", exampleMeaning: "Поезд был переполнен, поэтому я опоздала." },
    { id: "L26v7", word: "詳しい", reading: "くわしい", pitch: 3, meaning: "подробный; хорошо знающий", example: "この町に詳しいんですか。", exampleMeaning: "Вы хорошо знаете этот город?" },
    { id: "L26v8", word: "急ぎます", reading: "いそぎます", pitch: 3, meaning: "торопиться", example: "急いでいるんです。先に行ってください。", exampleMeaning: "Я тороплюсь. Идите вперёд, пожалуйста." },
    { id: "L26v9", word: "説明します", reading: "せつめいします", pitch: 0, meaning: "объяснить", example: "もう一度説明していただけませんか。", exampleMeaning: "Не могли бы вы объяснить ещё раз?" },
    { id: "L26v10", word: "両替します", reading: "りょうがえします", pitch: 0, meaning: "обменять деньги / разменять купюру", example: "千円を両替していただけませんか。", exampleMeaning: "Не могли бы вы разменять тысячу иен?" },
    { id: "L26v11", word: "書類", reading: "しょるい", pitch: 1, meaning: "документ; бумаги", example: "この書類を説明していただけませんか。", exampleMeaning: "Не могли бы вы объяснить этот документ?" },
    { id: "L26v12", word: "引っ越します", reading: "ひっこします", pitch: 3, meaning: "переезжать", example: "来月引っ越すんです。", exampleMeaning: "Я переезжаю в следующем месяце." },
    { id: "L26v13", word: "送ります", reading: "おくります", pitch: 0, meaning: "отправить; послать", example: "荷物を送っていただけませんか。", exampleMeaning: "Не могли бы вы отправить эту посылку?" },
    { id: "L26v14", word: "届けます", reading: "とどけます", pitch: 3, meaning: "доставить", example: "荷物が届いていません。", exampleMeaning: "Посылка ещё не доставлена." },
    { id: "L26v15", word: "預けます", reading: "あずけます", pitch: 3, meaning: "оставить на хранение", example: "荷物を預けていただけませんか。", exampleMeaning: "Не могли бы вы присмотреть за моим багажом?" },
    { id: "L26v16", word: "払います", reading: "はらいます", pitch: 3, meaning: "платить", example: "どこで払ったらいいですか。", exampleMeaning: "Где мне нужно оплатить?" },
    { id: "L26v17", word: "続きます", reading: "つづきます", pitch: 3, meaning: "продолжаться", example: "会議がまだ続いているんです。", exampleMeaning: "Собрание всё ещё продолжается." },
    { id: "L26v18", word: "遅れます", reading: "おくれます", pitch: 0, meaning: "опоздать; задержаться", example: "電車が遅れたんです。", exampleMeaning: "Поезд задержался." },
    { id: "L26v19", word: "間に合います", reading: "まにあいます", pitch: 0, meaning: "успеть; поспеть вовремя", example: "急がないと、間に合わないんです。", exampleMeaning: "Если не потороплюсь, не успею." },
    { id: "L26v20", word: "残業します", reading: "ざんぎょうします", pitch: 0, meaning: "работать сверхурочно", example: "今夜は残業するんです。", exampleMeaning: "Сегодня вечером я работаю сверхурочно." },
    { id: "L26v21", word: "用事", reading: "ようじ", pitch: 0, meaning: "дело; поручение", example: "用事があるんです。", exampleMeaning: "У меня есть дело." },
    { id: "L26v22", word: "予定", reading: "よてい", pitch: 0, meaning: "расписание; план", example: "予定が変わったんです。", exampleMeaning: "Расписание изменилось." },
    { id: "L26v23", word: "予約します", reading: "よやくします", pitch: 0, meaning: "забронировать; заказать", example: "ホテルを予約していただけませんか。", exampleMeaning: "Не могли бы вы забронировать отель?" },
    { id: "L26v24", word: "大切", reading: "たいせつ", pitch: 0, meaning: "важный; ценный (na-прил.)", example: "大切な書類なんです。", exampleMeaning: "Это важный документ." },
    { id: "L26v25", word: "無理", reading: "むり", pitch: 1, meaning: "невозможный; нереальный (na-прил.)", example: "今日は無理なんです。", exampleMeaning: "Сегодня мне невозможно." },
    { id: "L26v26", word: "もう一度", reading: "もういちど", pitch: 0, meaning: "ещё раз; ещё один раз", example: "もう一度説明していただけませんか。", exampleMeaning: "Не могли бы вы объяснить ещё раз?" },
    { id: "L26v27", word: "領収書", reading: "りょうしゅうしょ", pitch: 0, meaning: "квитанция; чек", example: "領収書を書いていただけませんか。", exampleMeaning: "Не могли бы вы выписать квитанцию?" },
    { id: "L26v28", word: "見積もり", reading: "みつもり", pitch: 0, meaning: "смета; расчёт", example: "見積もりを出していただけませんか。", exampleMeaning: "Не могли бы вы предоставить смету?" },
    { id: "L26v29", word: "荷物", reading: "にもつ", pitch: 0, meaning: "багаж; груз", example: "荷物を送りたいんです。", exampleMeaning: "Я хочу отправить багаж." },
    { id: "L26v30", word: "ゆっくり", reading: "ゆっくり", pitch: 0, meaning: "медленно; не торопясь", example: "ゆっくり話していただけませんか。", exampleMeaning: "Не могли бы вы говорить помедленнее?" }
  ],
  grammar: [
    {
      id: "L26g1",
      point: "〜んです (объяснение / вопрос о причине)",
      explanation: "Форма: простая форма ＋ んです (разговорная: んだ). na-прил./сущ. используют な перед んです (元気なんです / 学生なんです). Связывает высказывание с ситуацией: даёт причину, объяснение или спрашивает 'что случилось?'. 「どうしたんですか」= что случилось? — ответ через 〜んです. НЕ используется для простых нейтральных фактов.",
      examples: [
        "A: 顔色が悪いですね。B: 頭が痛いんです。 (Ты бледная. — У меня болит голова.)",
        "どうして来なかったんですか。 (Почему ты не пришла?)",
        "この料理、おいしいですね。自分で作ったんですか。 (Это вкусно. Ты сама приготовила?)"
      ],
      listening: "んです часто отвечает или спрашивает 'почему/что происходит'. Слушай な перед んです после существительного/na-прилагательного.",
      production: "Представь, что ты опоздала. Объясни причину с помощью 〜んです (например, поезд был переполнен)."
    },
    {
      id: "L26g2",
      point: "〜ていただけませんか (вежливая просьба)",
      explanation: "Форма: て-форма ＋ いただけませんか. Скромный, очень вежливый способ попросить что-то сделать — мягче, чем 〜てください. Используется с людьми, к которым нужно быть вежливым. Менее формальная альтернатива: 〜てもらえませんか.",
      examples: [
        "すみません、写真を撮っていただけませんか。 (Извините, не могли бы вы сделать фото?)",
        "この漢字の読み方を教えていただけませんか。 (Не могли бы вы научить меня читать этот кандзи?)",
        "もう少しゆっくり話していただけませんか。 (Не могли бы вы говорить немного помедленнее?)"
      ],
      listening: "Слушай て-форма ＋ いただけませんか как вежливую просьбу. か в конце делает её мягкой.",
      production: "Вежливо попроси незнакомца о двух небольших услугах, используя 〜ていただけませんか."
    },
    {
      id: "L26g3",
      point: "〜たらいいですか (вопрос о том, что следует делать)",
      explanation: "Форма: た-форма ＋ らいいですか. Используется для вопроса о инструкции/совете: 'Что/где/как мне…?'. Часто с вопросительным словом (どこ・何・いつ・どう).",
      examples: [
        "すみません、どこで払ったらいいですか。 (Извините, где мне оплатить?)",
        "何時に来たらいいですか。 (В котором часу мне прийти?)",
        "この書類はどう書いたらいいですか。 (Как мне заполнить этот документ?)"
      ],
      listening: "Вопросительное слово ＋ た-форма ＋ らいいですか означает 'что мне делать?'.",
      production: "Ты новый посетитель. Задай два вопроса 'что/где мне…?' используя 〜たらいいですか."
    }
  ],
  kanji: [
    { id: "L26k1", char: "約", reading: "やく", meaning: "обещание; примерно", exampleWord: "約束（やくそく）" },
    { id: "L26k2", char: "束", reading: "そく／たば", meaning: "связка; связывать", exampleWord: "約束（やくそく）" },
    { id: "L26k3", char: "急", reading: "きゅう／いそ（ぐ）", meaning: "спешка; срочный", exampleWord: "急ぎます（いそぎます）" },
    { id: "L26k4", char: "説", reading: "せつ／と（く）", meaning: "объяснять; теория", exampleWord: "説明（せつめい）" },
    { id: "L26k5", char: "故", reading: "こ／ゆえ", meaning: "причина; основание", exampleWord: "故障（こしょう）" },
    { id: "L26k6", char: "障", reading: "しょう／さわ（る）", meaning: "препятствие; мешать", exampleWord: "故障（こしょう）" },
    { id: "L26k7", char: "続", reading: "ぞく／つづ（く）", meaning: "продолжать(ся)", exampleWord: "続きます（つづきます）" },
    { id: "L26k8", char: "両", reading: "りょう", meaning: "оба; два", exampleWord: "両替（りょうがえ）" }
  ],
  reading: {
    id: "L26r1",
    title: "どうしたんですか",
  ...
  questions: [
    { id: "L26q1", dim: "grammar", type: "recall", difficulty: "easy", s: "顔色が悪いですね。― 頭が痛い___。(У меня болит голова.)", a: "んです", o: ["んです", "ました", "でしょう", "ています"], c: 0, exp: "〜んです даёт причину ситуации.", linksTo: "L26g1" },
    { id: "L26q2", dim: "grammar", type: "recall", difficulty: "hard", s: "学生 ＋ んです → ?", a: "学生なんです", o: ["学生んです", "学生だんです", "学生なんです", "学生のんです"], c: 2, exp: "Существительные / na-прил. используют な перед んです: 学生なんです.", linksTo: "L26g1" },
    { id: "L26q3", dim: "grammar", type: "recall", difficulty: "medium", s: "写真を撮っ___。(Не могли бы вы сделать фото? — очень вежливо)", a: "ていただけませんか", o: ["てください", "ていただけませんか", "てもいいですか", "ましょうか"], c: 1, exp: "て-форма ＋ いただけませんか = вежливая просьба.", linksTo: "L26g2" },
    { id: "L26q4", dim: "grammar", type: "recall", difficulty: "medium", s: "どこで払っ___いいですか。(Где мне оплатить?)", a: "たら", o: ["たら", "ても", "ながら", "ては"], c: 0, exp: "Вопросительное слово ＋ た-форма ＋ らいいですか = 'что/где мне…?'.", linksTo: "L26g3" },
    { id: "L26q5", dim: "vocab", type: "recognition", difficulty: "easy", s: "故障します означает…", a: "сломаться (о технике)", o: ["быть переполненным", "сломаться (о технике)", "торопиться", "объяснять"], c: 1, exp: "故障します = техника ломается. 込みます = быть переполненным.", linksTo: "L26v4" },
    { id: "L26q6", dim: "vocab", type: "recall", difficulty: "medium", s: "電車が___いて、遅れたんです。(переполнен)", a: "込んで", o: ["動いて", "込んで", "急いで", "直して"], c: 1, exp: "込みます = быть переполненным → 込んでいて.", linksTo: "L26v6" },
    { id: "L26q7", dim: "grammar", type: "recall", difficulty: "medium", s: "都合が悪い___。(Мне неудобно)", a: "んです", o: ["んです", "ます", "でしょう", "てから"], c: 0, exp: "〜んです объясняет ситуацию/причину.", linksTo: "L26g1" },
    { id: "L26q8", dim: "grammar", type: "recall", difficulty: "hard", s: "元気 ___ んですか。(Ты здорова? — na-прил.)", a: "な", o: ["な", "だ", "の", "い"], c: 0, exp: "na-прил. использует な перед んです: 元気なんです.", linksTo: "L26g1" },
    { id: "L26q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "遅れます означает…", a: "опоздать / задержаться", o: ["торопиться", "опоздать / задержаться", "продолжаться", "платить"], c: 1, exp: "遅れます (おくれます) = опоздать/задержаться.", linksTo: "L26v18" },
    { id: "L26q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "領収書 означает…", a: "квитанция", o: ["смета", "квитанция", "документ", "бронирование"], c: 1, exp: "領収書 (りょうしゅうしょ) = квитанция.", linksTo: "L26v27" },
    { id: "L26q11", dim: "vocab", type: "recall", difficulty: "medium", s: "荷物を___たいんです。(отправить)", a: "送り", o: ["送り", "届け", "預け", "払い"], c: 0, exp: "送ります = отправить. 届けます = доставить.", linksTo: "L26v13" },
    { id: "L26q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'продолжать' ?", a: "続", o: ["約", "急", "続", "説"], c: 2, exp: "続 → 続きます (продолжаться).", linksTo: "L26k7" }
  ]
},
...
/* ===================== LESSON 27 ===================== */
{
  lessonNum: 27,
  topic: "可能形（〜られます）",
  topicEn: "Потенциальная форма — Мочь делать",
  module: 'L27', moduleLabel: 'L27 — Потенциальная форма (мочь)', lesson: 'L27', lessonLabel: 'Потенциальная форма (мочь)',
  difficulty: "hard",
  level: "N4",
  vocabulary: [
    { id: "L27v1", word: "見えます", reading: "みえます", pitch: 3, meaning: "быть видимым; видеть (самопроизвольно)", example: "ここから海が見えます。", exampleMeaning: "Отсюда видно море." },
    { id: "L27v2", word: "聞こえます", reading: "きこえます", pitch: 4, meaning: "быть слышимым; слышать (самопроизвольно)", example: "鳥の声が聞こえます。", exampleMeaning: "Слышны голоса птиц." },
    { id: "L27v3", word: "できます", reading: "できます", pitch: 3, meaning: "мочь; быть выполненным", example: "日本語が少しできます。", exampleMeaning: "Я немного могу по-японски." },
    { id: "L27v4", word: "景色", reading: "けしき", pitch: 1, meaning: "пейзаж; вид", example: "山の上から景色が見えます。", exampleMeaning: "С вершины горы виден пейзаж." },
    { id: "L27v5", word: "翻訳します", reading: "ほんやくします", pitch: 0, meaning: "переводить", example: "この本は英語に翻訳できます。", exampleMeaning: "Эту книгу можно перевести на английский." },
    { id: "L27v6", word: "泳ぎます", reading: "およぎます", pitch: 3, meaning: "плавать", example: "100メートル泳げます。", exampleMeaning: "Я могу проплыть 100 метров." },
    { id: "L27v7", word: "信号", reading: "しんごう", pitch: 0, meaning: "светофор; сигнал", example: "信号が青になったら、渡れます。", exampleMeaning: "Когда свет станет зелёным, можно переходить." },
    { id: "L27v8", word: "ぜんぜん", reading: "ぜんぜん", pitch: 0, meaning: "совсем (не) (с отрицанием)", example: "漢字はぜんぜん読めません。", exampleMeaning: "Я совсем не могу читать кандзи." },
    { id: "L27v9", word: "届きます", reading: "とどきます", pitch: 3, meaning: "доходить; доставляться", example: "メールが届いたら、見られます。", exampleMeaning: "Когда письмо придёт, я смогу его прочитать." },
    { id: "L27v10", word: "ペット", reading: "ペット", pitch: 1, meaning: "домашнее животное", example: "このマンションではペットが飼えません。", exampleMeaning: "В этом доме нельзя держать питомцев." },
    { id: "L27v11", word: "飼います", reading: "かいます", pitch: 3, meaning: "держать (животное)", example: "犬を飼っています。", exampleMeaning: "Я держу собаку." },
    { id: "L27v12", word: "騒がしい", reading: "さわがしい", pitch: 4, meaning: "шумный (i-прил.)", example: "となりの部屋が騒がしくて、眠れません。", exampleMeaning: "Соседняя комната шумная, и я не могу уснуть." },
    { id: "L27v13", word: "壊します", reading: "こわします", pitch: 3, meaning: "сломать (что-то)", example: "子どもがおもちゃを壊しました。", exampleMeaning: "Ребёнок сломал игрушку." },
    { id: "L27v14", word: "道に迷います", reading: "みちにまよいます", pitch: 0, meaning: "заблудиться", example: "道に迷って、遅れました。", exampleMeaning: "Я заблудилась и опоздала." },
    { id: "L27v15", word: "予約します", reading: "よやくします", pitch: 0, meaning: "забронировать; заказать", example: "ホテルが予約できます。", exampleMeaning: "Можно забронировать отель." },
    { id: "L27v16", word: "乗ります", reading: "のります", pitch: 3, meaning: "сесть (в транспорт)", example: "このバスには乗れません。", exampleMeaning: "Я не могу сесть в этот автобус." },
    { id: "L27v17", word: "降ります", reading: "おります", pitch: 2, meaning: "выйти (из транспорта)", example: "次の駅で降りられます。", exampleMeaning: "Можно выйти на следующей станции." },
    { id: "L27v18", word: "履きます", reading: "はきます", pitch: 3, meaning: "надеть (обувь)", example: "この靴が履けません。", exampleMeaning: "Я не могу надеть эту обувь." },
    { id: "L27v19", word: "着ます", reading: "きます", pitch: 0, meaning: "надеть (одежду)", example: "この服が着られます。", exampleMeaning: "Я могу надеть эту одежду." },
    { id: "L27v20", word: "被ります", reading: "かぶります", pitch: 3, meaning: "надеть (шляпу)", example: "帽子が被れます。", exampleMeaning: "Я могу надеть шляпу." },
    { id: "L27v21", word: "練習します", reading: "れんしゅうします", pitch: 0, meaning: "практиковаться", example: "毎日練習すれば、上手になれます。", exampleMeaning: "Если практиковаться каждый день, можно стать лучше." },
    { id: "L27v22", word: "上手", reading: "じょうず", pitch: 3, meaning: "умелый; хороший (na-прил.)", example: "日本語が上手に話せます。", exampleMeaning: "Я хорошо говорю по-японски." },
    { id: "L27v23", word: "下手", reading: "へた", pitch: 2, meaning: "неумелый; плохой (na-прил.)", example: "料理が下手で、うまく作れません。", exampleMeaning: "Я плохо готовлю и не могу сделать это хорошо." },
    { id: "L27v24", word: "できるだけ", reading: "できるだけ", pitch: 0, meaning: "настолько, насколько возможно", example: "できるだけ早く来られます。", exampleMeaning: "Я могу прийти как можно раньше." },
    { id: "L27v25", word: "特技", reading: "とくぎ", pitch: 2, meaning: "особый навык", example: "特技はピアノが弾けることです。", exampleMeaning: "Мой навык — умение играть на пианино." },
    { id: "L27v26", word: "趣味", reading: "しゅみ", pitch: 1, meaning: "хобби", example: "趣味は写真が撮れることです。", exampleMeaning: "Моё хобби — умение фотографировать." },
    { id: "L27v27", word: "約束します", reading: "やくそくします", pitch: 0, meaning: "обещать", example: "約束を守れます。", exampleMeaning: "Я могу сдержать обещание." },
    { id: "L27v28", word: "間に合います", reading: "まにあいます", pitch: 0, meaning: "успеть вовремя", example: "走れば、間に合えます。", exampleMeaning: "Если побегу, успею." },
    { id: "L27v29", word: "間に合いません", reading: "まにあいません", pitch: 0, meaning: "не успеть вовремя", example: "この電車では間に合いません。", exampleMeaning: "На этом поезде не успею." },
    { id: "L27v30", word: "無理", reading: "むり", pitch: 1, meaning: "невозможно (na-прил.)", example: "今日は無理です。来られません。", exampleMeaning: "Сегодня невозможно. Не могу прийти." }
  ],
  grammar: [
    {
      id: "L27g1",
      point: "可能形 — потенциальные глаголы (мочь делать)",
      explanation: "Группа I: изменить конечный звук -u на -eru (書く→書ける, 話す→話せる, 泳ぐ→泳げる). Группа II: убрать ます, добавить られます/られる (食べます→食べられます, 見ます→見られます). Исключения: します→できます, 来ます→来られます. Объект обычно принимает が (или сохраняет を): 日本語が話せます. Заметь, что 見えます/聞こえます — самопроизвольные, тогда как 見られます/聞けます означают 'можешь увидеть/услышать если попробуешь'.",
      examples: [
        "私は漢字が少し書けます。 (Я немного могу писать кандзи.)",
        "あした来られますか。 (Ты можешь прийти завтра?)",
        "ここで写真が撮れますか。 (Здесь можно фотографировать?)"
      ],
      listening: "Потенциальные глаголы оканчиваются на -eru / られる. が часто отмечает то, что ты можешь делать.",
      production: "Перечисли три вещи, которые ты можешь и не можешь делать, используя потенциальную форму (〜が…ます／…ません)."
    },
    {
      id: "L27g2",
      point: "〜が見えます / 〜が聞こえます (самопроизвольно видимо / слышимо)",
      explanation: "Используй эти формы, когда что-то появляется в поле зрения или слуха само по себе, без твоего усилия. Сравнение: 窓から富士山が見えます (просто видно) vs. メガネをかければ富士山が見られます (можешь увидеть если попробуешь).",
      examples: [
        "部屋から花火が見えます。 (Из комнаты виден фейерверк.)",
        "となりの部屋から音楽が聞こえます。 (Из соседней комнаты слышна музыка.)",
        "電車の音が聞こえて、眠れませんでした。 (Я слышала поезд и не могла уснуть.)"
      ],
      listening: "見えます／聞こえます описывают то, что естественно достигает глаз/ушей, с частицей が.",
      production: "Опиши, что ты видишь и слышишь из своего окна, используя 見えます / 聞こえます."
    },
    {
      id: "L27g3",
      point: "〜しか〜ない (только / ничего кроме)",
      explanation: "〜しか всегда используется с отрицательным глаголом, но несёт положительный смысл 'только'. しか заменяет を/が (и может следовать за другими частицами). Подчёркивает, что количество меньше ожидаемого: 100円しかありません = У меня только 100 иен.",
      examples: [
        "ひらがなしか読めません。 (Я могу читать только хирагану.)",
        "けさはパンしか食べませんでした。 (Сегодня утром я ела только хлеб.)",
        "一人しか来ませんでした。 (Пришёл только один человек.)"
      ],
      listening: "しか означает 'только', но глагол остаётся отрицательным — не перепутай с настоящим отрицанием.",
      production: "Скажи два предложения 'у меня только / я могу только…' используя 〜しか〜ない."
    }
  ],
  kanji: [
    { id: "L27k1", char: "見", reading: "けん／み（る）", meaning: "видеть; смотреть", exampleWord: "見えます（みえます）" },
    { id: "L27k2", char: "聞", reading: "ぶん／き（く）", meaning: "слышать; слушать; спрашивать", exampleWord: "聞こえます（きこえます）" },
    { id: "L27k3", char: "泳", reading: "えい／およ（ぐ）", meaning: "плавать", exampleWord: "泳げます（およげます）" },
    { id: "L27k4", char: "信", reading: "しん", meaning: "доверие; сигнал; верить", exampleWord: "信号（しんごう）" },
    { id: "L27k5", char: "号", reading: "ごう", meaning: "знак; номер; сигнал", exampleWord: "信号（しんごう）" },
    { id: "L27k6", char: "景", reading: "けい", meaning: "пейзаж; вид", exampleWord: "景色（けしき）" },
    { id: "L27k7", char: "色", reading: "しき／いろ／しょく", meaning: "цвет", exampleWord: "景色（けしき）" },
    { id: "L27k8", char: "訳", reading: "やく／わけ", meaning: "перевод; причина", exampleWord: "翻訳（ほんやく）" }
  ],
  reading: {
    id: "L27r1",
    title: "新しいへや",
  ...
  questions: [
    { id: "L27q1", dim: "grammar", type: "recall", difficulty: "medium", s: "書きます → потенциальная форма?", a: "書けます", o: ["書きられます", "書けます", "書かれます", "書けります"], c: 1, exp: "Группа I: -ku → -keru. 書く→書ける→書けます.", linksTo: "L27g1" },
    { id: "L27q2", dim: "grammar", type: "recall", difficulty: "medium", s: "食べます → потенциальная форма?", a: "食べられます", o: ["食べれます", "食べられます", "食べます", "食べさせます"], c: 1, exp: "Группа II: убрать ます, добавить られます. (食べれます — разговорная форма без ら.)", linksTo: "L27g1" },
    { id: "L27q3", dim: "grammar", type: "recall", difficulty: "hard", s: "となりの部屋から音楽が___。(слышно, самопроизвольно)", a: "聞こえます", o: ["聞けます", "聞こえます", "聞かれます", "聞きます"], c: 1, exp: "Самопроизвольное слышание = 聞こえます (не 聞けます).", linksTo: "L27g2" },
    { id: "L27q4", dim: "grammar", type: "recall", difficulty: "hard", s: "100円___ありません。(У меня только 100 иен.)", a: "しか", o: ["だけ", "しか", "でも", "ほど"], c: 1, exp: "しか + отрицательный глагол = 'только'. だけ требует положительного глагола.", linksTo: "L27g3" },
    { id: "L27q5", dim: "vocab", type: "recognition", difficulty: "easy", s: "景色 означает…", a: "пейзаж", o: ["светофор", "пейзаж", "питомец", "сигнал"], c: 1, exp: "景色 (けしき) = пейзаж/вид.", linksTo: "L27v4" },
    { id: "L27q6", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'слышать / слушать' ?", a: "聞", o: ["見", "聞", "泳", "信"], c: 1, exp: "聞 = слышать/слушать → 聞こえます.", linksTo: "L27k2" },
    { id: "L27q7", dim: "grammar", type: "recall", difficulty: "medium", s: "話します → потенциальная форма?", a: "話せます", o: ["話せます", "話れます", "話かれます", "話します"], c: 0, exp: "Группа I: -su → -seru. 話す→話せる→話せます.", linksTo: "L27g1" },
    { id: "L27q8", dim: "grammar", type: "recall", difficulty: "hard", s: "ひらがな___読めません。(Я могу читать только хирагану.)", a: "しか", o: ["しか", "だけ", "でも", "が"], c: 0, exp: "しか ＋ отрицание = 'только'. だけ требует положительной формы.", linksTo: "L27g3" },
    { id: "L27q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "飼います означает…", a: "держать (питомца)", o: ["покупать", "держать (питомца)", "ехать", "надевать"], c: 1, exp: "飼います (かいます) = держать/разводить питомца.", linksTo: "L27v11" },
    { id: "L27q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "騒がしい означает…", a: "шумный", o: ["тихий", "шумный", "красивый", "удобный"], c: 1, exp: "騒がしい (さわがしい) = шумный/громкий.", linksTo: "L27v12" },
    { id: "L27q11", dim: "vocab", type: "recall", difficulty: "medium", s: "道に___、遅れました。(заблудилась)", a: "迷って", o: ["迷って", "乗って", "降りて", "履いて"], c: 0, exp: "道に迷います = заблудиться.", linksTo: "L27v14" },
    { id: "L27q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какая пара кандзи читается как «けしき» (пейзаж)?", a: "景色", o: ["信号", "景色", "翻訳", "見えます"], c: 1, exp: "景色（けしき）= пейзаж/вид.", linksTo: "L27k6" }
  ]
},
...
/* ===================== LESSON 28 ===================== */
{
  lessonNum: 28,
  topic: "〜ながら・〜ています（習慣）・〜し",
  topicEn: "Пока · Привычки · Перечисление причин",
  module: 'L28', moduleLabel: 'L28 — Пока · Привычки · И (し)', lesson: 'L28', lessonLabel: 'Пока · Привычки · И (し)',
  difficulty: "medium",
  level: "N4",
  vocabulary: [
    { id: "L28v1", word: "通います", reading: "かよいます", pitch: 3, meaning: "ездить (на учебу/работу); посещать регулярно", example: "毎日、自転車で学校に通っています。", exampleMeaning: "Я езжу в школу на велосипеде каждый день." },
    { id: "L28v2", word: "続けます", reading: "つづけます", pitch: 3, meaning: "продолжать", example: "10年間ピアノを続けています。", exampleMeaning: "Я продолжаю играть на пианино 10 лет." },
    { id: "L28v3", word: "残業します", reading: "ざんぎょうします", pitch: 0, meaning: "работать сверхурочно", example: "今週は毎日残業しています。", exampleMeaning: "На этой неделе я работаю сверхурочно каждый день." },
    { id: "L28v4", word: "別々に", reading: "べつべつに", pitch: 0, meaning: "раздельно", example: "別々に払いましょう。", exampleMeaning: "Давайте заплатим раздельно." },
    { id: "L28v5", word: "メモします", reading: "メモします", pitch: 1, meaning: "записывать; делать заметки", example: "話を聞きながら、メモします。", exampleMeaning: "Я делаю заметки, слушая." },
    { id: "L28v6", word: "ためます", reading: "ためます", pitch: 3, meaning: "копить; накапливать", example: "働きながら、お金をためています。", exampleMeaning: "Я коплю деньги, работая." },
    { id: "L28v7", word: "貿易", reading: "ぼうえき", pitch: 0, meaning: "торговля (коммерция)", example: "貿易の会社で働いています。", exampleMeaning: "Я работаю в торговой компании." },
    { id: "L28v8", word: "親切", reading: "しんせつ", pitch: 1, meaning: "добрый (na-прил.)", example: "この店は安いし、店員も親切です。", exampleMeaning: "Этот магазин дешёвый, и персонал добрый." },
    { id: "L28v9", word: "まじめ", reading: "まじめ", pitch: 0, meaning: "серьёзный; прилежный (na-прил.)", example: "彼はまじめだし、よく働きます。", exampleMeaning: "Он прилежный и много работает." },
    { id: "L28v10", word: "番組", reading: "ばんぐみ", pitch: 0, meaning: "программа (ТВ/радио)", example: "ごはんを食べながら、番組を見ます。", exampleMeaning: "Я смотрю программу, пока ем." },
    { id: "L28v11", word: "習います", reading: "ならいます", pitch: 3, meaning: "учиться (у кого-то)", example: "3年間、日本語を習っています。", exampleMeaning: "Я учу японский 3 года." },
    { id: "L28v12", word: "教えます", reading: "おしえます", pitch: 3, meaning: "учить; преподавать", example: "ピアノを教えながら、自分も練習します。", exampleMeaning: "Я преподаю пианино и сама практиковаться." },
    { id: "L28v13", word: "集めます", reading: "あつめます", pitch: 3, meaning: "собирать", example: "切手を集めています。", exampleMeaning: "Я коллекционирую марки." },
    { id: "L28v14", word: "貯金します", reading: "ちょきんします", pitch: 0, meaning: "копить деньги (в банке)", example: "毎月貯金しています。", exampleMeaning: "Я коплю деньги каждый месяц." },
    { id: "L28v15", word: "設計します", reading: "せっけいします", pitch: 0, meaning: "проектировать; планировать", example: "建物の設計をしています。", exampleMeaning: "Я проектирую здания." },
    { id: "L28v16", word: "建築", reading: "けんちく", pitch: 0, meaning: "архитектура; строительство", example: "建築の勉強をしています。", exampleMeaning: "Я изучаю архитектуру." },
    { id: "L28v17", word: "経営します", reading: "けいえいします", pitch: 0, meaning: "управлять (бизнесом)", example: "父が店を経営しています。", exampleMeaning: "Мой отец управляет магазином." },
    { id: "L28v18", word: "農業", reading: "のうぎょう", pitch: 0, meaning: "сельское хозяйство", example: "農業をしています。", exampleMeaning: "Я занимаюсь сельским хозяйством." },
    { id: "L28v19", word: "漁業", reading: "ぎょぎょう", pitch: 0, meaning: "рыбная промышленность", example: "この町は漁業が盛んです。", exampleMeaning: "Этот город процветает за счёт рыболовства." },
    { id: "L28v20", word: "工場", reading: "こうじょう", pitch: 3, meaning: "завод; фабрика", example: "工場で働いています。", exampleMeaning: "Я работаю на заводе." },
    { id: "L28v21", word: "病院", reading: "びょういん", pitch: 0, meaning: "больница", example: "病院に通っています。", exampleMeaning: "Я регулярно хожу в больницу." },
    { id: "L28v22", word: "市役所", reading: "しやくしょ", pitch: 2, meaning: "мэрия; городская администрация", example: "市役所で働いています。", exampleMeaning: "Я работаю в мэрии." },
    { id: "L28v23", word: "便利", reading: "べんり", pitch: 1, meaning: "удобный (na-прил.)", example: "この町は便利だし、住みやすいです。", exampleMeaning: "Этот город удобный и жить в нём легко." },
    { id: "L28v24", word: "不便", reading: "ふべん", pitch: 1, meaning: "неудобный (na-прил.)", example: "駅が遠くて不便です。", exampleMeaning: "Станция далеко и это неудобно." },
    { id: "L28v25", word: "健康", reading: "けんこう", pitch: 0, meaning: "здоровье; здоровый (na-прил.)", example: "健康のために、毎朝走っています。", exampleMeaning: "Ради здоровья я бегаю каждое утро." },
    { id: "L28v26", word: "理想", reading: "りそう", pitch: 0, meaning: "идеал", example: "理想の生活を求めています。", exampleMeaning: "Я ищу идеальный образ жизни." },
    { id: "L28v27", word: "現実", reading: "げんじつ", pitch: 0, meaning: "реальность", example: "現実は厳しいです。", exampleMeaning: "Реальность сурова." },
    { id: "L28v28", word: "我慢します", reading: "がまんします", pitch: 0, meaning: "терпеть; мириться", example: "我慢して働いています。", exampleMeaning: "Я терплю и продолжаю работать." },
    { id: "L28v29", word: "希望", reading: "きぼう", pitch: 0, meaning: "надежда; стремление", example: "希望を持って続けています。", exampleMeaning: "Я продолжаю с надеждой." },
    { id: "L28v30", word: "おしろい", reading: "おしろい", pitch: 0, meaning: "пудра для лица", example: "おしろいをつけながら、踊ります。", exampleMeaning: "Я танцую, нанося пудру." }
  ],
  grammar: [
    {
      id: "L28g1",
      point: "〜ながら (делать два дела одновременно)",
      explanation: "Форма: ます-основа глагола ＋ ながら ＋ главная часть. Один субъект делает два действия одновременно; ВТОРОЙ (главный) глагол — основное действие. 音楽を聞きながら勉強します = учиться (главное), слушая музыку (фон).",
      examples: [
        "コーヒーを飲みながら、新聞を読みます。 (Я читаю газету, попивая кофе.)",
        "歌を歌いながら、シャワーを浴びます。 (Я пою в душе.)",
        "話しながら歩きましょう。 (Давайте разговаривать, гуляя.)"
      ],
      listening: "ます-основа ＋ ながら отмечает фоновое действие; главный глагол идёт после.",
      production: "Опиши два дела, которые ты часто делаешь одновременно, используя 〜ながら."
    },
    {
      id: "L28g2",
      point: "〜ています (привычное / продолжающееся действие)",
      explanation: "Помимо 'делать прямо сейчас', 〜ています выражает повторяющуюся привычку или долгосрочное действие/состояние: профессия, регулярная рутина, продолжающееся обучение. 銀行で働いています = Я работаю в банке (постоянно). 日本語を勉強しています = Я изучаю японский в последнее время.",
      examples: [
        "貿易の会社で働いています。 (Я работаю в торговой компании.)",
        "毎朝ジョギングをしています。 (Я бегаю каждое утро.)",
        "3年間、日本語を習っています。 (Я учу японский 3 года.)"
      ],
      listening: "〜ています может означать привычку/профессию, не только 'прямо сейчас'. Контекст (毎日, 〜年間) подскажет.",
      production: "Скажи, кем ты работаешь/учишься и одну ежедневную привычку, обе через 〜ています."
    },
    {
      id: "L28g3",
      point: "〜し、〜し (перечисление причин / 'и к тому же')",
      explanation: "Форма: простая форма ＋ し. Перечисляет две или более причины или качества, подразумевая 'и к тому же'. Часто последняя часть содержит вывод: この店は安いし、おいしいし、よく来ます. na-прил./сущ.: 親切だし / 学生だし.",
      examples: [
        "この部屋は広いし、駅も近いし、気に入っています。 (Просторная и рядом со станцией, мне нравится.)",
        "彼は親切だし、まじめだし、みんなに好かれています。 (Он добрый и прилежный, всем нравится.)",
        "きょうは寒いし、雨だし、出かけたくないです。 (Холодно и дождливо, не хочу выходить.)"
      ],
      listening: "Повторяющееся 〜し накапливает причины; ожидай вывод или чувство в конце.",
      production: "Назови две причины, почему тебе что-то нравится, используя 〜し、〜し."
    }
  ],
  kanji: [
    { id: "L28k1", char: "通", reading: "つう／かよ（う）／とお（る）", meaning: "проходить; ездить", exampleWord: "通います（かよいます）" },
    { id: "L28k2", char: "続", reading: "ぞく／つづ（く）", meaning: "продолжать", exampleWord: "続けます（つづけます）" },
    { id: "L28k3", char: "親", reading: "しん／おや", meaning: "родитель; близость; добрый", exampleWord: "親切（しんせつ）" },
    { id: "L28k4", char: "番", reading: "ばん", meaning: "номер; очередь", exampleWord: "番組（ばんぐみ）" },
    { id: "L28k5", char: "組", reading: "そ／くみ", meaning: "группа; организация", exampleWord: "番組（ばんぐみ）" },
    { id: "L28k6", char: "貿", reading: "ぼう", meaning: "торговля", exampleWord: "貿易（ぼうえき）" },
    { id: "L28k7", char: "易", reading: "えき／やさ（しい）", meaning: "лёгкий; торговля", exampleWord: "貿易（ぼうえき）" },
    { id: "L28k8", char: "切", reading: "せつ／き（る）", meaning: "резать; серьёзный", exampleWord: "親切（しんせつ）" }
  ],
  reading: {
    id: "L28r1",
    title: "わたしの一日",
  ...
  questions: [
    { id: "L28q1", dim: "grammar", type: "recall", difficulty: "easy", s: "音楽を聞き___、勉強します。(пока слушаю)", a: "ながら", o: ["ながら", "たら", "ても", "ので"], c: 0, exp: "ます-основа ＋ ながら = 'пока делаю'.", linksTo: "L28g1" },
    { id: "L28q2", dim: "grammar", type: "recall", difficulty: "hard", s: "Что правильно для 'учиться, слушая' ?", a: "聞きながら勉強します", o: ["勉強しながら聞きます", "聞きながら勉強します", "聞くながら勉強します", "聞いてながら勉強します"], c: 1, exp: "ГЛАВНОЕ действие (учиться) идёт после ながら; используй ます-основу 聞き.", linksTo: "L28g1" },
    { id: "L28q3", dim: "grammar", type: "recall", difficulty: "medium", s: "貿易の会社で働い___。(Я работаю — постоянная профессия)", a: "ています", o: ["ます", "ています", "ました", "たいです"], c: 1, exp: "Профессии используют 〜ています (постоянное состояние).", linksTo: "L28g2" },
    { id: "L28q4", dim: "grammar", type: "recall", difficulty: "medium", s: "安い___、おいしい___、よく来ます。(дёшево И вкусно…)", a: "し / し", o: ["て / て", "し / し", "から / から", "が / が"], c: 1, exp: "〜し накапливает причины: 安いし、おいしいし.", linksTo: "L28g3" },
    { id: "L28q5", dim: "vocab", type: "recognition", difficulty: "easy", s: "通います означает…", a: "ездить / посещать регулярно", o: ["продолжать", "ездить / посещать регулярно", "копить", "работать сверхурочно"], c: 1, exp: "通います = ездить/посещать регулярно.", linksTo: "L28v1" },
    { id: "L28q6", dim: "vocab", type: "recall", difficulty: "medium", s: "彼は___だし、よく働きます。(прилежный)", a: "まじめ", o: ["親切", "まじめ", "別々", "残業"], c: 1, exp: "まじめ = серьёзный/прилежный.", linksTo: "L28v9" },
    { id: "L28q7", dim: "grammar", type: "recall", difficulty: "medium", s: "毎朝ジョギングを___。(привычное — каждое утро)", a: "しています", o: ["します", "しています", "しました", "したいです"], c: 1, exp: "〜ています для привычных/постоянных действий.", linksTo: "L28g2" },
    { id: "L28q8", dim: "grammar", type: "recall", difficulty: "hard", s: "親切___、まじめ___、みんなに好かれています。", a: "だし / だし", o: ["だし / だし", "し / し", "て / て", "な / な"], c: 0, exp: "na-прил. ＋ だし перечисляет качества.", linksTo: "L28g3" },
    { id: "L28q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "貯金します означает…", a: "копить деньги", o: ["тратить деньги", "копить деньги", "занимать", "платить"], c: 1, exp: "貯金します (ちょきんします) = копить деньги.", linksTo: "L28v14" },
    { id: "L28q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "工場 означает…", a: "завод", o: ["больница", "завод", "мэрия", "магазин"], c: 1, exp: "工場 (こうじょう) = завод/фабрика.", linksTo: "L28v20" },
    { id: "L28q11", dim: "vocab", type: "recall", difficulty: "medium", s: "毎月___しています。(коплю деньги)", a: "貯金", o: ["貯金", "残業", "我慢", "希望"], c: 0, exp: "貯金します = копить деньги (в банке).", linksTo: "L28v14" },
    { id: "L28q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какая пара кандзи читается как «ぼうえき» (торговля)?", a: "貿易", o: ["番組", "貿易", "親切", "通います"], c: 1, exp: "貿易（ぼうえき）= торговля.", linksTo: "L28k6" }
  ]
},
...
/* ===================== LESSON 29 ===================== */
{
  ...
  topicEn: "Результативные состояния & Завершение/Сожаление",
  module: 'L29', moduleLabel: 'L29 — Результативные состояния & 〜てしまう', lesson: 'L29', lessonLabel: 'Результативные состояния & 〜てしまう',
  difficulty: "medium",
  level: "N4",
  vocabulary: [
    { id: "L29v1", word: "割れます", reading: "われます", pitch: 3, meaning: "разбиться (непереходный)", example: "コップが割れています。", exampleMeaning: "Стакан разбит." },
    { id: "L29v2", word: "壊れます", reading: "こわれます", pitch: 3, meaning: "сломаться (непереходный)", example: "いすが壊れています。", exampleMeaning: "Стул сломан." },
    { id: "L29v3", word: "消えます", reading: "きえます", pitch: 3, meaning: "погаснуть; исчезнуть (непереходный)", example: "電気が消えています。", exampleMeaning: "Свет выключен." },
    { id: "L29v4", word: "つきます", reading: "つきます", pitch: 2, meaning: "включиться; гореть (непереходный)", example: "エアコンがついています。", exampleMeaning: "Кондиционер включён." },
    { id: "L29v5", word: "落とします", reading: "おとします", pitch: 4, meaning: "уронить; потерять (переходный)", example: "財布を落としてしまいました。", exampleMeaning: "Я уронила кошелёк." },
    { id: "L29v6", word: "なくします", reading: "なくします", pitch: 0, meaning: "потерять (что-то)", example: "かぎをなくしてしまいました。", exampleMeaning: "Я потеряла ключ." },
    { id: "L29v7", word: "汚れます", reading: "よごれます", pitch: 4, meaning: "испачкаться (непереходный)", example: "シャツが汚れています。", exampleMeaning: "Рубашка испачкана." },
    { id: "L29v8", word: "間違えます", reading: "まちがえます", pitch: 4, meaning: "ошибиться; перепутать", example: "電車を間違えてしまいました。", exampleMeaning: "Я села не на тот поезд." },
    { id: "L29v9", word: "故郷", reading: "ふるさと", pitch: 2, meaning: "родной город", example: "故郷の写真を見ると、なつかしいです。", exampleMeaning: "Когда вижу фото родного города, становится ностальгично." },
    { id: "L29v10", word: "忘れ物", reading: "わすれもの", pitch: 0, meaning: "забытая вещь", example: "電車に忘れ物をしてしまいました。", exampleMeaning: "Я забыла вещь в поезде." },
    { id: "L29v11", word: "開きます", reading: "あきます", pitch: 2, meaning: "открыться (непереходный)", example: "ドアが開いています。", exampleMeaning: "Дверь открыта." },
    { id: "L29v12", word: "閉まります", reading: "しまります", pitch: 2, meaning: "закрыться (непереходный)", example: "ドアが閉まっています。", exampleMeaning: "Дверь закрыта." },
    { id: "L29v13", word: "開けます", reading: "あけます", pitch: 2, meaning: "открыть (переходный)", example: "窓を開けておきました。", exampleMeaning: "Я заранее открыла окно." },
    { id: "L29v14", word: "閉めます", reading: "しめます", pitch: 2, meaning: "закрыть (переходный)", example: "ドアを閉めてください。", exampleMeaning: "Пожалуйста, закрой дверь." },
    { id: "L29v15", word: "つけます", reading: "つけます", pitch: 2, meaning: "включить; прикрепить (переходный)", example: "電気をつけてください。", exampleMeaning: "Пожалуйста, включи свет." },
    { id: "L29v16", word: "消します", reading: "けします", pitch: 2, meaning: "выключить; стереть (переходный)", example: "電気を消してください。", exampleMeaning: "Пожалуйста, выключи свет." },
    { id: "L29v17", word: "割ります", reading: "わります", pitch: 2, meaning: "разбить (переходный — стекло/тарелка)", example: "子どもがコップを割りました。", exampleMeaning: "Ребёнок разбил стакан." },
    { id: "L29v18", word: "壊します", reading: "こわします", pitch: 3, meaning: "сломать (переходный)", example: "いすを壊してしまいました。", exampleMeaning: "Я сломала стул." },
    { id: "L29v19", word: "汚します", reading: "よごします", pitch: 3, meaning: "испачкать (переходный)", example: "シャツを汚してしまいました。", exampleMeaning: "Я испачкала рубашку." },
    { id: "L29v20", word: "落とします", reading: "おとします", pitch: 4, meaning: "уронить; потерять (переходный)", example: "財布を落としてしまいました。", exampleMeaning: "Я уронила кошелёк." },
    { id: "L29v21", word: "寝坊します", reading: "ねぼうします", pitch: 0, meaning: "проспать", example: "けさ寝坊してしまいました。", exampleMeaning: "Сегодня утром я проспала." },
    { id: "L29v22", word: "遅刻します", reading: "ちこくします", pitch: 0, meaning: "опоздать (куда-то)", example: "遅刻してしまいました。", exampleMeaning: "Я опоздала." },
    { id: "L29v23", word: "約束を破ります", reading: "やくそくをやぶります", pitch: 0, meaning: "нарушить обещание", example: "約束を破ってしまいました。", exampleMeaning: "Я нарушила обещание." },
    { id: "L29v24", word: "失敗します", reading: "しっぱいします", pitch: 0, meaning: "потерпеть неудачу; ошибиться", example: "失敗してしまいました。", exampleMeaning: "Я ошиблась." },
    { id: "L29v25", word: "大事", reading: "だいじ", pitch: 1, meaning: "важный; ценный (na-прил.)", example: "大事な書類をなくしました。", exampleMeaning: "Я потеряла важный документ." },
    { id: "L29v26", word: "大切", reading: "たいせつ", pitch: 0, meaning: "дорогой; важный (na-прил.)", example: "大切なものです。", exampleMeaning: "Это дорогая вещь." },
    { id: "L29v27", word: "なつかしい", reading: "なつかしい", pitch: 4, meaning: "ностальгический (i-прил.)", example: "故郷の写真を見ると、なつかしいです。", exampleMeaning: "Фото родного города вызывают ностальгию." },
    { id: "L29v28", word: "おかしい", reading: "おかしい", pitch: 0, meaning: "странный; нелепый (i-прил.)", example: "何かおかしいですね。", exampleMeaning: "Что-то странное." },
    { id: "L29v29", word: "慌てます", reading: "あわてます", pitch: 3, meaning: "паниковать; торопиться", example: "慌てて、かぎを忘れました。", exampleMeaning: "Я запаниковала и забыла ключ." },
    { id: "L29v30", word: "元気", reading: "げんき", pitch: 1, meaning: "здоровый; бодрый (na-прил.)", example: "元気になっていました。", exampleMeaning: "Он выздоровел." }
  ],
  grammar: [
    {
      id: "L29g1",
      point: "〜ています (состояние в результате изменения)",
      explanation: "С непереходными глаголами изменения (割れる, 壊れる, 消える, つく, 開く, 閉まる, 汚れる…), 〜ています описывает результативное СОСТОЯНИЕ, а не действие в процессе. 窓が割れています = окно в разбитом состоянии. Сравнение: 雨が降っています = идёт дождь (действие в процессе).",
      examples: [
        "電気が消えています。だれもいないんでしょう。 (Свет выключен; наверное, никого нет.)",
        "あ、さいふが落ちていますよ。 (О, кошелёк лежит.)",
        "ドアが開いていますね。閉めましょうか。 (Дверь открыта. Закрыть?)"
      ],
      listening: "С глаголами изменения 〜ています = текущее состояние (разбито/выключено/открыто), не 'в процессе действия'.",
      production: "Осмотрись вокруг и опиши три состояния, используя 〜ています (например, окно открыто)."
    },
    {
      id: "L29g2",
      point: "〜てしまいます / 〜てしまいました (завершение или сожаление)",
      explanation: "Форма: て-форма ＋ しまいます. Два значения: (1) полностью закончить что-то — 宿題をやってしまいました; (2) сожаление о непреднамеренном результате — 電車に傘を忘れてしまいました. Разговорные сокращения: 〜ちゃう (〜てしまう) / 〜じゃう (〜でしまう).",
      examples: [
        "この本はおもしろくて、一日で読んでしまいました。 (Книга такая интересная, я прочитала её за день.)",
        "大切な書類をなくしてしまいました。 (Я потеряла важный документ — сожаление.)",
        "ケーキを全部食べてしまいました。 (Я в итоге съела весь торт.)"
      ],
      listening: "〜てしまいました часто несёт чувство 'ой/наконец-то' — слушай контекст, чтобы различить завершение и сожаление.",
      production: "Расскажи одно дело, которое ты случайно сделала, и одно, которое полностью закончила, оба через 〜てしまいました."
    }
  ],
  kanji: [
    { id: "L29k1", char: "消", reading: "しょう／き（える）／け（す）", meaning: "гасить; исчезать", exampleWord: "消えます（きえます）" },
    { id: "L29k2", char: "落", reading: "らく／お（ちる）／お（とす）", meaning: "падать; ронять", exampleWord: "落とします（おとします）" },
    { id: "L29k3", char: "汚", reading: "お／よご（れる）／きたな（い）", meaning: "грязный; пачкать", exampleWord: "汚れます（よごれます）" },
    { id: "L29k4", char: "間", reading: "かん／あいだ／ま", meaning: "интервал; между", exampleWord: "間違えます（まちがえます）" },
    { id: "L29k5", char: "違", reading: "い／ちが（う）", meaning: "отличаться; ошибаться", exampleWord: "間違えます（まちがえます）" },
    { id: "L29k6", char: "割", reading: "かつ／わ（る）／わ（れる）", meaning: "разбивать; трескать", exampleWord: "割れます（われます）" },
    { id: "L29k7", char: "壊", reading: "かい／こわ（れる）／こわ（す）", meaning: "ломать; разрушать", exampleWord: "壊れます（こわれます）" },
    { id: "L29k8", char: "忘", reading: "ぼう／わす（れる）", meaning: "забывать", exampleWord: "忘れ物（わすれもの）" }
  ],
  reading: {
    id: "L29r1",
    title: "たいへんな朝",
  ...
  questions: [
    { id: "L29q1", dim: "grammar", type: "recall", difficulty: "medium", s: "電気が___。だれもいないんでしょう。(Свет выключен — состояние)", a: "消えています", o: ["消します", "消えています", "消えます", "消しています"], c: 1, exp: "Глагол изменения 消える ＋ ています = результативное состояние ('выключен').", linksTo: "L29g1" },
    { id: "L29q2", dim: "grammar", type: "recall", difficulty: "hard", s: "Что описывает СОСТОЯНИЕ, а не действие в процессе?", a: "ドアが開いています", o: ["雨が降っています", "ご飯を食べています", "ドアが開いています", "本を読んでいます"], c: 2, exp: "開く — глагол изменения → 開いています = 'открыта' (состояние).", linksTo: "L29g1" },
    { id: "L29q3", dim: "grammar", type: "recall", difficulty: "easy", s: "傘を電車に忘れ___。(Я забыла — сожаление)", a: "てしまいました", o: ["ました", "てしまいました", "ています", "ておきました"], c: 1, exp: "〜てしまいました выражает сожаление о непреднамеренном результате.", linksTo: "L29g2" },
    { id: "L29q4", dim: "grammar", type: "recall", difficulty: "hard", s: "Разговорная форма 食べてしまう — это…", a: "食べちゃう", o: ["食べじゃう", "食べちゃう", "食べとく", "食べてる"], c: 1, exp: "〜てしまう → 〜ちゃう (〜でしまう → 〜じゃう).", linksTo: "L29g2" },
    { id: "L29q5", dim: "vocab", type: "recognition", difficulty: "medium", s: "Какая пара верна (непереходный)?", a: "割れます = разбиться (само)", o: ["割れます = разбить (что-то)", "割れます = разбиться (само)", "落とします = упасть", "消します = погаснуть"], c: 1, exp: "割れます — непереходный; 割ります — переходный ('разбить что-то').", linksTo: "L29v1" },
    { id: "L29q6", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'падать / ронять' ?", a: "落", o: ["消", "落", "汚", "間"], c: 1, exp: "落 → 落とします (уронить).", linksTo: "L29k2" },
    { id: "L29q7", dim: "grammar", type: "recall", difficulty: "medium", s: "ドアが___。開いている状態です。(открыта — состояние)", a: "開いています", o: ["開けています", "開いています", "開けます", "開きます"], c: 1, exp: "Непереходный 開く ＋ ています = состояние 'открыто'.", linksTo: "L29g1" },
    { id: "L29q8", dim: "grammar", type: "recall", difficulty: "hard", s: "宿題を全部___。(полностью закончила)", a: "やってしまいました", o: ["やっています", "やってしまいました", "やっておきました", "やりました"], c: 1, exp: "〜てしまいました = завершение (полностью закончила).", linksTo: "L29g2" },
    { id: "L29q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "寝坊します означает…", a: "проспать", o: ["опоздать", "проспать", "забыть", "потерять"], c: 1, exp: "寝坊します (ねぼうします) = проспать.", linksTo: "L29v21" },
    { id: "L29q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "失敗します означает…", a: "потерпеть неудачу / ошибиться", o: ["преуспеть", "потерпеть неудачу / ошибиться", "торопиться", "отдыхать"], c: 1, exp: "失敗します (しっぱいします) = потерпеть неудачу.", linksTo: "L29v24" },
    { id: "L29q11", dim: "vocab", type: "recall", difficulty: "medium", s: "電気を___ください。(выключи)", a: "消して", o: ["消して", "つけて", "開けて", "閉めて"], c: 0, exp: "消します = выключить (переходный).", linksTo: "L29v16" },
    { id: "L29q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'забывать' ?", a: "忘", o: ["消", "落", "汚", "忘"], c: 3, exp: "忘 → 忘れ物 (забытая вещь).", linksTo: "L29k8" }
  ]
},
...
/* ===================== LESSON 30 ===================== */
{
  lessonNum: 30,
  topic: "〜てあります・〜ておきます",
  topicEn: "Результативное состояние (намеренное) & Заранее",
  module: 'L30', moduleLabel: 'L30 — 〜てあります & 〜ておきます', lesson: 'L30', lessonLabel: '〜てあります & 〜ておきます',
  difficulty: "hard",
  level: "N4",
  vocabulary: [
    { id: "L30v1", word: "貼ります", reading: "はります", pitch: 2, meaning: "наклеить; повесить (объявление)", example: "かべに地図が貼ってあります。", exampleMeaning: "Карта наклеена на стене." },
    { id: "L30v2", word: "掛けます", reading: "かけます", pitch: 3, meaning: "повесить", example: "かべに絵が掛けてあります。", exampleMeaning: "Картина висит на стене." },
    { id: "L30v3", word: "並べます", reading: "ならべます", pitch: 4, meaning: "расставить; разложить", example: "テーブルにお皿が並べてあります。", exampleMeaning: "Тарелки расставлены на столе." },
    { id: "L30v4", word: "戻します", reading: "もどします", pitch: 4, meaning: "положить обратно; вернуть", example: "使ったら、元の所に戻しておきます。", exampleMeaning: "После использования положу обратно на место." },
    { id: "L30v5", word: "準備します", reading: "じゅんびします", pitch: 0, meaning: "готовиться; подготовить", example: "会議の前に資料を準備しておきます。", exampleMeaning: "Подготовлю документы до собрания." },
    { id: "L30v6", word: "予約します", reading: "よやくします", pitch: 0, meaning: "забронировать; заказать", example: "旅行の前にホテルを予約しておきます。", exampleMeaning: "Забронирую отель до поездки." },
    { id: "L30v7", word: "片付けます", reading: "かたづけます", pitch: 4, meaning: "убраться; привести в порядок", example: "お客さんが来る前に部屋を片付けておきます。", exampleMeaning: "Уберу комнату до прихода гостей." },
    { id: "L30v8", word: "しまいます", reading: "しまいます", pitch: 3, meaning: "убрать на место", example: "使った後、はさみを引き出しにしまっておきます。", exampleMeaning: "После использования уберу ножницы в ящик." },
    { id: "L30v9", word: "資料", reading: "しりょう", pitch: 1, meaning: "материалы; документы", example: "机の上に資料が置いてあります。", exampleMeaning: "Материалы лежат на столе." },
    { id: "L30v10", word: "そのまま", reading: "そのまま", pitch: 0, meaning: "как есть; оставить как есть", example: "それはそのまま置いておいてください。", exampleMeaning: "Пожалуйста, оставьте это как есть." },
    { id: "L30v11", word: "飾ります", reading: "かざります", pitch: 3, meaning: "украшать", example: "テーブルに花が飾ってあります。", exampleMeaning: "Цветы украшают стол." },
    { id: "L30v12", word: "置きます", reading: "おきます", pitch: 2, meaning: "положить; поставить", example: "資料が机の上に置いてあります。", exampleMeaning: "Материалы положены на стол." },
    { id: "L30v13", word: "集めます", reading: "あつめます", pitch: 3, meaning: "собрать", example: "会議の資料を集めておきます。", exampleMeaning: "Соберу материалы для собрания заранее." },
    { id: "L30v14", word: "コピーします", reading: "コピーします", pitch: 1, meaning: "копировать; сделать копии", example: "資料をコピーしておきます。", exampleMeaning: "Сделаю копии материалов заранее." },
    { id: "L30v15", word: "冷蔵庫", reading: "れいぞうこ", pitch: 3, meaning: "холодильник", example: "ビールは冷蔵庫に入れてあります。", exampleMeaning: "Пиво в холодильнике." },
    { id: "L30v16", word: "壁", reading: "かべ", pitch: 2, meaning: "стена", example: "壁に地図が貼ってあります。", exampleMeaning: "Карта наклеена на стене." },
    { id: "L30v17", word: "引き出し", reading: "ひきだし", pitch: 3, meaning: "ящик", example: "はさみは引き出しに入れてあります。", exampleMeaning: "Ножницы в ящике." },
    { id: "L30v18", word: "花瓶", reading: "かびん", pitch: 1, meaning: "ваза", example: "花瓶に花が飾ってあります。", exampleMeaning: "Цветы стоят в вазе." },
    { id: "L30v19", word: "看板", reading: "かんばん", pitch: 0, meaning: "вывеска; знак", example: "店の前に看板が置いてあります。", exampleMeaning: "Вывеска стоит перед магазином." },
    { id: "L30v20", word: "忘れ物", reading: "わすれもの", pitch: 0, meaning: "забытая вещь", example: "忘れ物がないようにしておいてください。", exampleMeaning: "Пожалуйста, убедись, что ничего не забыла." },
    { id: "L30v21", word: "約束します", reading: "やくそくします", pitch: 0, meaning: "договориться; обещать", example: "先生と約束しておきます。", exampleMeaning: "Заранее договорюсь с учителем." },
    { id: "L30v22", word: "確認します", reading: "かくにんします", pitch: 0, meaning: "подтвердить; проверить", example: "時間を確認しておきます。", exampleMeaning: "Заранее проверю время." },
    { id: "L30v23", word: "連絡します", reading: "れんらくします", pitch: 0, meaning: "связаться", example: "会社に連絡しておきます。", exampleMeaning: "Заранее свяжусь с компанией." },
    { id: "L30v24", word: "届けます", reading: "とどけます", pitch: 3, meaning: "доставить", example: "荷物を届けておきます。", exampleMeaning: "Заранее доставлю посылку." },
    { id: "L30v25", word: "預けます", reading: "あずけます", pitch: 3, meaning: "оставить на хранение", example: "荷物を預けておきます。", exampleMeaning: "Заранее оставлю багаж на хранение." },
    { id: "L30v26", word: "換えます", reading: "かえます", pitch: 3, meaning: "заменить; обменять", example: "電球を換えておきました。", exampleMeaning: "Я заранее поменяла лампочку." },
    { id: "L30v27", word: "直します", reading: "なおします", pitch: 4, meaning: "починить; исправить", example: "壊れた時計を直しておきます。", exampleMeaning: "Заранее починю сломанные часы." },
    { id: "L30v28", word: "洗います", reading: "あらいます", pitch: 3, meaning: "мыть", example: "お皿を洗っておきます。", exampleMeaning: "Заранее помою тарелки." },
    { id: "L30v29", word: "磨きます", reading: "みがきます", pitch: 3, meaning: "чистить; полировать", example: "歯を磨いておきます。", exampleMeaning: "Заранее почищу зубы." },
    { id: "L30v30", word: "元", reading: "もと", pitch: 0, meaning: "прежний; исходный", example: "元の所に戻しておきます。", exampleMeaning: "Положу обратно на прежнее место." }
  ],
  grammar: [
    {
      id: "L30g1",
      point: "〜てあります (результативное состояние намеренного действия)",
      explanation: "Форма: ПЕРЕХОДНЫЙ глагол て-форма ＋ あります. Описывает состояние, оставшееся потому что кто-то сделал это НАМЕРЕННО (часто для какой-то цели). Воздействуемый предмет отмечается が. 窓が開けてあります = окно было намеренно открыто (и осталось открытым). Сравнение: 窓が開いています (просто 'открыто', нейтрально, непереходный).",
      examples: [
        "テーブルに花が飾ってあります。 (Цветы украшают стол — намеренно.)",
        "予定はカレンダーに書いてあります。 (Расписание написано в календаре.)",
        "ビールは冷蔵庫に入れてあります。 (Пиво положили в холодильник — готово.)"
      ],
      listening: "〜てあります использует переходный глагол ＋が и подразумевает, что кто-то подготовил это намеренно; 〜ています с непереходным глаголом — просто нейтральное состояние.",
      production: "Опиши две вещи в своей комнате, которые были установлены намеренно, используя 〜てあります."
    },
    {
      id: "L30g2",
      point: "〜ておきます (сделать заранее / оставить что-то сделанным)",
      explanation: "Форма: て-форма ＋ おきます. (1) Сделать что-то заранее как подготовку: 旅行の前に予約しておきます. (2) Оставить состояние как есть / закончить и оставить: そのままにしておいてください. Разговорное сокращение: 〜とく (予約しとく).",
      examples: [
        "会議の前に、資料をコピーしておきます。 (Я сделаю копии материалов до собрания.)",
        "パーティーのために、飲み物を買っておきました。 (Я заранее купила напитки для вечеринки.)",
        "使った後は、元の所に戻しておいてください。 (После использования, пожалуйста, положи обратно на место.)"
      ],
      listening: "〜ておきます означает подготовку 'заранее' или 'оставить сделанным'. Слушай おきます после て-формы.",
      production: "Назови два дела, которые ты сделала бы заранее перед поездкой, используя 〜ておきます."
    }
  ],
  kanji: [
    { id: "L30k1", char: "並", reading: "へい／なら（ぶ）／なら（べる）", meaning: "выстраивать; ряд", exampleWord: "並べます（ならべます）" },
    { id: "L30k2", char: "準", reading: "じゅん", meaning: "стандарт; подготовка", exampleWord: "準備（じゅんび）" },
    { id: "L30k3", char: "予", reading: "よ", meaning: "заранее; предварительно", exampleWord: "予約（よやく）" },
    { id: "L30k4", char: "資", reading: "し", meaning: "ресурсы; материалы", exampleWord: "資料（しりょう）" },
    { id: "L30k5", char: "料", reading: "りょう", meaning: "плата; материалы", exampleWord: "資料（しりょう）" },
    { id: "L30k6", char: "備", reading: "び", meaning: "готовить; оснащать", exampleWord: "準備（じゅんび）" },
    { id: "L30k7", char: "約", reading: "やく", meaning: "обещание; примерно", exampleWord: "予約（よやく）" },
    { id: "L30k8", char: "壁", reading: "へき／かべ", meaning: "стена", exampleWord: "壁（かべ）" }
  ],
  reading: {
    id: "L30r1",
    title: "パーティーのじゅんび",
  ...
  questions: [
    { id: "L30q1", dim: "grammar", type: "recall", difficulty: "hard", s: "かべに地図が貼っ___。(наклеена — намеренно)", a: "てあります", o: ["ています", "てあります", "ておきます", "てしまいます"], c: 1, exp: "Переходный 貼る ＋ てあります = состояние, созданное намеренно (が отмечает 地図).", linksTo: "L30g1" },
    { id: "L30q2", dim: "grammar", type: "recall", difficulty: "hard", s: "Выбери естественное предложение с 〜てあります.", a: "窓が開けてあります", o: ["窓を開けてあります", "窓が開けてあります", "窓が開いてあります", "窓を開いてあります"], c: 1, exp: "〜てあります требует が ＋ переходный глагол: 窓が開けてあります.", linksTo: "L30g1" },
    { id: "L30q3", dim: "grammar", type: "recall", difficulty: "medium", s: "旅行の前にホテルを予約し___。(сделать заранее)", a: "ておきます", o: ["てあります", "ておきます", "ています", "てしまいます"], c: 1, exp: "〜ておきます = сделать заранее как подготовку.", linksTo: "L30g2" },
    { id: "L30q4", dim: "grammar", type: "recall", difficulty: "easy", s: "そのままにし___ください。(оставь как есть)", a: "ておいて", o: ["てあって", "ておいて", "てしまって", "ていて"], c: 1, exp: "〜ておく также означает 'оставить состояние как есть'.", linksTo: "L30g2" },
    { id: "L30q5", dim: "vocab", type: "recognition", difficulty: "easy", s: "片付けます означает…", a: "убраться", o: ["готовиться", "бронировать", "убраться", "расставить"], c: 2, exp: "片付けます = убраться / привести в порядок.", linksTo: "L30v7" },
    { id: "L30q6", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'заранее / предварительно' ?", a: "予", o: ["並", "準", "予", "資"], c: 2, exp: "予 → 予約（よやく）бронировать заранее.", linksTo: "L30k3" },
    { id: "L30q7", dim: "grammar", type: "recall", difficulty: "hard", s: "ビールは冷蔵庫に___。(положили — намеренно)", a: "入れてあります", o: ["入ってあります", "入れてあります", "入れています", "入っています"], c: 1, exp: "Переходный 入れる ＋ てあります = намеренное состояние.", linksTo: "L30g1" },
    { id: "L30q8", dim: "grammar", type: "recall", difficulty: "medium", s: "会議の前に資料をコピー___。(сделать заранее)", a: "しておきます", o: ["してあります", "しておきます", "しています", "してしまいます"], c: 1, exp: "〜ておきます = сделать заранее как подготовку.", linksTo: "L30g2" },
    { id: "L30q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "飾ります означает…", a: "украшать", o: ["мыть", "украшать", "копировать", "подтверждать"], c: 1, exp: "飾ります (かざります) = украшать.", linksTo: "L30v11" },
    { id: "L30q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "冷蔵庫 означает…", a: "холодильник", o: ["ящик", "холодильник", "стена", "ваза"], c: 1, exp: "冷蔵庫 (れいぞうこ) = холодильник.", linksTo: "L30v15" },
    { id: "L30q11", dim: "vocab", type: "recall", difficulty: "medium", s: "時間を___しておきます。(подтвердить)", a: "確認", o: ["確認", "予約", "連絡", "準備"], c: 0, exp: "確認します = подтвердить/проверить.", linksTo: "L30v22" },
    { id: "L30q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какая пара кандзи читается как «じゅんび» (подготовка)?", a: "準備", o: ["資料", "準備", "予約", "壁"], c: 1, exp: "準備（じゅんび）= подготовка.", linksTo: "L30k2" }
  ]
}
...
/* ===================== LESSON 31 ===================== */
{
  ...
  topicEn: "Волитивная форма & Намерения / Планы",
  module: 'L31', moduleLabel: 'L31 — Волитив & Намерения', lesson: 'L31', lessonLabel: 'Волитив & Намерения',
  difficulty: "hard",
  level: "N4",
  vocabulary: [
    { id: "L31v1", word: "予定", reading: "よてい", pitch: 0, meaning: "расписание; план (фиксированный)", example: "来月、国へ帰る予定です。", exampleMeaning: "Я планирую поехать домой в следующем месяце." },
    { id: "L31v2", word: "計画", reading: "けいかく", pitch: 0, meaning: "план", example: "旅行の計画を立てています。", exampleMeaning: "Я составляю план поездки." },
    { id: "L31v3", word: "決めます", reading: "きめます", pitch: 0, meaning: "решать", example: "来年留学しようと決めました。", exampleMeaning: "Я решила учиться за границей в следующем году." },
    { id: "L31v4", word: "申し込みます", reading: "もうしこみます", pitch: 5, meaning: "подавать заявку; записаться", example: "あした試験に申し込もうと思っています。", exampleMeaning: "Я думаю подать заявку на экзамен завтра." },
    { id: "L31v5", word: "案内します", reading: "あんないします", pitch: 0, meaning: "проводить; показать", example: "週末、町を案内するつもりです。", exampleMeaning: "Я планирую показать тебе город в выходные." },
    { id: "L31v6", word: "泊まります", reading: "とまります", pitch: 3, meaning: "остаться на ночь", example: "京都で2泊しようと思っています。", exampleMeaning: "Я думаю остановиться на 2 ночи в Киото." },
    { id: "L31v7", word: "増えます", reading: "ふえます", pitch: 3, meaning: "увеличиться", example: "貯金を増やすつもりです。", exampleMeaning: "Я планирую увеличить сбережения." },
    { id: "L31v8", word: "やめます", reading: "やめます", pitch: 3, meaning: "бросить; прекратить (привычку)", example: "たばこをやめようと思っています。", exampleMeaning: "Я думаю бросить курить." },
    { id: "L31v9", word: "育てます", reading: "そだてます", pitch: 3, meaning: "выращивать; воспитывать", example: "庭で野菜を育てるつもりです。", exampleMeaning: "Я планирую выращивать овощи в саду." },
    { id: "L31v10", word: "そろそろ", reading: "そろそろ", pitch: 1, meaning: "скоро; пора", example: "そろそろ帰ろうと思います。", exampleMeaning: "Думаю, скоро пойду домой." },
    { id: "L31v11", word: "引っ越します", reading: "ひっこします", pitch: 3, meaning: "переезжать", example: "来月引っ越そうと思っています。", exampleMeaning: "Я думаю переехать в следующем месяце." },
    { id: "L31v12", word: "転職します", reading: "てんしょくします", pitch: 0, meaning: "сменить работу", example: "転職しようと計画しています。", exampleMeaning: "Я планирую сменить работу." },
    { id: "L31v13", word: "結婚します", reading: "けっこんします", pitch: 0, meaning: "выйти замуж / жениться", example: "来年結婚するつもりです。", exampleMeaning: "Я планирую выйти замуж в следующем году." },
    { id: "L31v14", word: "帰ります", reading: "かえります", pitch: 3, meaning: "вернуться; пойти домой", example: "夏休みに国へ帰ろうと思っています。", exampleMeaning: "Я думаю поехать домой на летние каникулы." },
    { id: "L31v15", word: "登ります", reading: "のぼります", pitch: 3, meaning: "лезть; подниматься", example: "山に登ろうと思っています。", exampleMeaning: "Я думаю подняться на гору." },
    { id: "L31v16", word: "泊まります", reading: "とまります", pitch: 3, meaning: "остановиться (в отеле)", example: "ホテルに2泊する予定です。", exampleMeaning: "Я планирую остановиться на 2 ночи в отеле." },
    { id: "L31v17", word: "増やします", reading: "ふやします", pitch: 3, meaning: "увеличить (переходный)", example: "貯金を増やそうと思っています。", exampleMeaning: "Я думаю увеличить сбережения." },
    { id: "L31v18", word: "減ります", reading: "へります", pitch: 2, meaning: "уменьшиться (непереходный)", example: "体重が減る予定です。", exampleMeaning: "Ожидается, что мой вес уменьшится." },
    { id: "L31v19", word: "続けます", reading: "つづけます", pitch: 3, meaning: "продолжать", example: "日本語の勉強を続けようと思っています。", exampleMeaning: "Я думаю продолжить изучение японского." },
    { id: "L31v20", word: "やせます", reading: "やせます", pitch: 3, meaning: "похудеть", example: "やせようと思っています。", exampleMeaning: "Я думаю похудеть." },
    { id: "L31v21", word: "けずります", reading: "けずります", pitch: 3, meaning: "сократить; уменьшить", example: "お酒をけずろうと思っています。", exampleMeaning: "Я думаю сократить алкоголь." },
    { id: "L31v22", word: "なおします", reading: "なおします", pitch: 4, meaning: "исправить; наладить", example: "生活をなおそうと思っています。", exampleMeaning: "Я думаю наладить свой образ жизни." },
    { id: "L31v23", word: "思い切って", reading: "おもいきって", pitch: 4, meaning: "решившись; осмелившись", example: "思い切って転職しました。", exampleMeaning: "Я решилась и сменила работу." },
    { id: "L31v24", word: "決心します", reading: "けっしんします", pitch: 0, meaning: "принять решение", example: "留学する決心をしました。", exampleMeaning: "Я решилась учиться за границей." },
    { id: "L31v25", word: "楽しみ", reading: "たのしみ", pitch: 3, meaning: "ожидание; удовольствие", example: "旅行が楽しみです。", exampleMeaning: "Я с нетерпением жду поездки." },
    { id: "L31v26", word: "目標", reading: "もくひょう", pitch: 1, meaning: "цель; задача", example: "目標を決めようと思います。", exampleMeaning: "Я поставлю цель." },
    { id: "L31v27", word: "実現します", reading: "じつげんします", pitch: 0, meaning: "осуществить; воплотить", example: "夢を実現するつもりです。", exampleMeaning: "Я планирую воплотить мечту в реальность." },
    { id: "L31v28", word: "応援します", reading: "おうえんします", pitch: 0, meaning: "поддерживать; болеть за", example: "みんなで応援するつもりです。", exampleMeaning: "Мы планируем поддержать тебя." },
    { id: "L31v29", word: "期待します", reading: "きたいします", pitch: 0, meaning: "ожидать; надеяться", example: "結果を期待しています。", exampleMeaning: "Я ожидаю результатов." },
    { id: "L31v30", word: "再開します", reading: "さいかいします", pitch: 0, meaning: "возобновить", example: "勉強を再開しようと思っています。", exampleMeaning: "Я думаю возобновить занятия." }
  ],
  grammar: [
    {
      id: "L31g1",
      point: "意向形 — волитивная форма (давай / я буду…)",
      explanation: "Группа I: конечный -u → -ou (行く→行こう, 話す→話そう). Группа II: убрать ます, добавить よう (食べます→食べよう, 見ます→見よう). Исключения: します→しよう, 来ます→来よう. Простая волитивная форма — это разговорная форма ましょう ('давай / мне…'). Сама по себе означает 'давай…' или 'я буду…'.",
      examples: [
        "ちょっと休もう。 (Давай немного отдохнём.)",
        "もう遅いから、帰ろう。 (Уже поздно, пойдём домой.)",
        "今日は早く寝よう。 (Сегодня лягу пораньше.)"
      ],
      listening: "Волитив оканчивается на -ou / -you. Сам по себе это разговорное 'давай…'.",
      production: "Предложи другу три дела, используя простую волитивную форму (休もう, 食べよう…)."
    },
    {
      id: "L31g2",
      point: "〜（よ）うと思っています (я думаю сделать)",
      explanation: "Волитив ＋ と思っています выражает намерение, которое ты уже держишь в уме. 〜と思います (без ている) — решение, принятое на ходу. Сравни с 〜つもりです (твёрдый план/намерение) и 〜予定です (фиксированное расписание, часто установленное другими или расписанием).",
      examples: [
        "夏休みに国へ帰ろうと思っています。 (Я думаю поехать домой на летние каникулы.)",
        "毎日30分歩くつもりです。 (Я намерена ходить 30 минут каждый день.)",
        "会議は3時から始まる予定です。 (Собрание назначено на 3 часа.)"
      ],
      listening: "〜ようと思っています = держимое намерение; 〜つもり = твёрдый план; 〜予定 = фиксированное расписание.",
      production: "Скажи одно намерение через 〜ようと思っています и один твёрдый план через 〜つもりです."
    }
  ],
  kanji: [
    { id: "L31k1", char: "予", reading: "よ", meaning: "заранее; предварительно", exampleWord: "予定（よてい）" },
    { id: "L31k2", char: "定", reading: "てい／さだ（める）", meaning: "определять; решать", exampleWord: "予定（よてい）" },
    { id: "L31k3", char: "計", reading: "けい／はか（る）", meaning: "план; измерять", exampleWord: "計画（けいかく）" },
    { id: "L31k4", char: "画", reading: "が／かく", meaning: "картинка; план", exampleWord: "計画（けいかく）" },
    { id: "L31k5", char: "画", reading: "が／かく", meaning: "картинка; план", exampleWord: "計画（けいかく）" },
    { id: "L31k6", char: "増", reading: "ぞう／ふ（える）／ふ（やす）", meaning: "увеличивать", exampleWord: "増えます（ふえます）" },
    { id: "L31k7", char: "育", reading: "いく／そだ（つ）／そだ（てる）", meaning: "выращивать; расти", exampleWord: "育てます（そだてます）" },
    { id: "L31k8", char: "泊", reading: "はく／と（まる）", meaning: "остаться на ночь", exampleWord: "泊まります（とまります）" }
  ],
  reading: {
    id: "L31r1",
    title: "夏休みの計画",
  ...
  questions: [
    { id: "L31q1", dim: "grammar", type: "recall", difficulty: "medium", s: "行きます → волитивная форма?", a: "行こう", o: ["行こう", "行きよう", "行かよう", "行けよう"], c: 0, exp: "Группа I: -ku → -kou. 行く→行こう.", linksTo: "L31g1" },
    { id: "L31q2", dim: "grammar", type: "recall", difficulty: "medium", s: "食べます → волитивная форма?", a: "食べよう", o: ["食べよう", "食べろう", "食べおう", "食べよ"], c: 0, exp: "Группа II: убрать ます, добавить よう. 食べます→食べよう.", linksTo: "L31g1" },
    { id: "L31q3", dim: "grammar", type: "recall", difficulty: "hard", s: "夏休みに国へ帰ろう___。(я думаю…)", a: "と思っています", o: ["と思っています", "ています", "つもりです", "でしょう"], c: 0, exp: "Волитив ＋ と思っています = держимое намерение.", linksTo: "L31g2" },
    { id: "L31q4", dim: "grammar", type: "recall", difficulty: "hard", s: "会議は3時から始まる___。(по расписанию)", a: "予定です", o: ["つもりです", "予定です", "と思います", "ようです"], c: 1, exp: "Фиксированное расписание использует 〜予定です, не つもり.", linksTo: "L31g2" },
    { id: "L31q5", dim: "vocab", type: "recognition", difficulty: "easy", s: "申し込みます означает…", a: "подать заявку / записаться", o: ["решать", "подать заявку / записаться", "увеличить", "бросить"], c: 1, exp: "申し込みます = подать заявку / записаться.", linksTo: "L31v4" },
    { id: "L31q6", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какая пара кандзи читается как «よてい» ?", a: "予定", o: ["計画", "予定", "予約", "決定"], c: 1, exp: "予定（よてい）= расписание.", linksTo: "L31k1" },
    { id: "L31q7", dim: "grammar", type: "recall", difficulty: "medium", s: "します → волитивная форма?", a: "しよう", o: ["しよう", "すよう", "しう", "すろう"], c: 0, exp: "Исключение: する→しよう.", linksTo: "L31g1" },
    { id: "L31q8", dim: "grammar", type: "recall", difficulty: "hard", s: "毎日30分歩く___。(твёрдый план)", a: "つもりです", o: ["つもりです", "予定です", "ようです", "そうです"], c: 0, exp: "つもりです = твёрдое личное намерение/план.", linksTo: "L31g2" },
    { id: "L31q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "転職します означает…", a: "сменить работу", o: ["переезжать", "сменить работу", "выйти замуж", "бросить"], c: 1, exp: "転職します (てんしょくします) = сменить работу.", linksTo: "L31v12" },
    { id: "L31q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "目標 означает…", a: "цель / задача", o: ["расписание", "цель / задача", "удовольствие", "ожидание"], c: 1, exp: "目標 (もくひょう) = цель/задача.", linksTo: "L31v26" },
    { id: "L31q11", dim: "vocab", type: "recall", difficulty: "medium", s: "体重が___予定です。(уменьшится)", a: "減る", o: ["減る", "増える", "続ける", "変わる"], c: 0, exp: "減ります (へります) = уменьшиться.", linksTo: "L31v18" },
    { id: "L31q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'увеличивать' ?", a: "増", o: ["予", "定", "計", "増"], c: 3, exp: "増 → 増えます / 増やします (увеличивать).", linksTo: "L31k6" }
  ]
},
...
/* ===================== LESSON 32 ===================== */
{
  ...
  topicEn: "Советы, Вероятность & Возможность",
  module: 'L32', moduleLabel: 'L32 — Советы & Вероятность', lesson: 'L32', lessonLabel: 'Советы & Вероятность',
  difficulty: "medium",
  level: "N4",
  vocabulary: [
    { id: "L32v1", word: "運動します", reading: "うんどうします", pitch: 0, meaning: "заниматься спортом", example: "毎日運動したほうがいいですよ。", exampleMeaning: "Тебе лучше заниматься спортом каждый день." },
    { id: "L32v2", word: "無理", reading: "むり", pitch: 1, meaning: "перенапряжение; чрезмерное (na-прил.)", example: "無理をしないほうがいいです。", exampleMeaning: "Тебе лучше не перенапрягаться." },
    { id: "L32v3", word: "倒れます", reading: "たおれます", pitch: 3, meaning: "упасть; свалиться", example: "働きすぎると、倒れるかもしれません。", exampleMeaning: "Если будешь перерабатывать, можешь упасть." },
    { id: "L32v4", word: "気をつけます", reading: "きをつけます", pitch: 0, meaning: "быть осторожным", example: "かぜに気をつけたほうがいいです。", exampleMeaning: "Тебе лучше беречься от простуды." },
    { id: "L32v5", word: "危険", reading: "きけん", pitch: 0, meaning: "опасность; опасный (na-прил.)", example: "夜、一人で歩くのは危険でしょう。", exampleMeaning: "Ходить ночью одному, наверное, опасно." },
    { id: "L32v6", word: "たぶん", reading: "たぶん", pitch: 1, meaning: "наверное; вероятно", example: "彼はたぶん来るでしょう。", exampleMeaning: "Он, наверное, придёт." },
    { id: "L32v7", word: "効果", reading: "こうか", pitch: 1, meaning: "эффект", example: "この薬は効果があるかもしれません。", exampleMeaning: "Это лекарство, возможно, эффективное." },
    { id: "L32v8", word: "変わります", reading: "かわります", pitch: 4, meaning: "измениться", example: "天気が変わるかもしれません。", exampleMeaning: "Погода может измениться." },
    { id: "L32v9", word: "止めます", reading: "とめます", pitch: 3, meaning: "остановить; припарковать", example: "ここに車を止めないほうがいいです。", exampleMeaning: "Тебе лучше не парковаться здесь." },
    { id: "L32v10", word: "向かいます", reading: "むかいます", pitch: 4, meaning: "направляться", example: "台風がこちらに向かっているでしょう。", exampleMeaning: "Тайфун, вероятно, движется сюда." },
    { id: "L32v11", word: "診察します", reading: "しんさつします", pitch: 0, meaning: "осматривать (пациента)", example: "医者が診察してくれました。", exampleMeaning: "Врач осмотрел меня." },
    { id: "L32v12", word: "薬", reading: "くすり", pitch: 3, meaning: "лекарство", example: "薬を飲んだほうがいいですよ。", exampleMeaning: "Тебе лучше выпить лекарство." },
    { id: "L32v13", word: "効きます", reading: "ききます", pitch: 3, meaning: "действовать; быть эффективным", example: "この薬はよく効くでしょう。", exampleMeaning: "Это лекарство, вероятно, хорошо подействует." },
    { id: "L32v14", word: "熱", reading: "ねつ", pitch: 2, meaning: "температура (жар)", example: "熱があるなら、休んだほうがいいです。", exampleMeaning: "Если у тебя температура, лучше отдохнуть." },
    { id: "L32v15", word: "下がります", reading: "さがります", pitch: 3, meaning: "снизиться; упасть", example: "熱が下がるかもしれません。", exampleMeaning: "Температура может снизиться." },
    { id: "L32v16", word: "上がります", reading: "あがります", pitch: 4, meaning: "подняться; вырасти", example: "熱が上がったら、病院に行ってください。", exampleMeaning: "Если температура поднимется, иди в больницу." },
    { id: "L32v17", word: "おなか", reading: "おなか", pitch: 0, meaning: "живот", example: "おなかが痛いなら、薬を飲んだほうがいいです。", exampleMeaning: "Если болит живот, лучше выпить лекарство." },
    { id: "L32v18", word: "けが", reading: "けが", pitch: 1, meaning: "травма", example: "けがをしないように気をつけてください。", exampleMeaning: "Пожалуйста, будь осторожен, чтобы не получить травму." },
    { id: "L32v19", word: "治ります", reading: "なおります", pitch: 3, meaning: "вылечиться; зажить", example: "すぐに治るでしょう。", exampleMeaning: "Наверное, скоро заживёт." },
    { id: "L32v20", word: "無駄", reading: "むだ", pitch: 1, meaning: "бесполезный; напрасный (na-прил.)", example: "無駄な買い物をしないほうがいいです。", exampleMeaning: "Тебе лучше не делать бесполезных покупок." },
    { id: "L32v21", word: "大切", reading: "たいせつ", pitch: 0, meaning: "важный (na-прил.)", example: "健康が大切です。", exampleMeaning: "Здоровье важно." },
    { id: "L32v22", word: "心配します", reading: "しんぱいします", pitch: 0, meaning: "беспокоиться", example: "心配しないほうがいいですよ。", exampleMeaning: "Тебе лучше не беспокоиться." },
    { id: "L32v23", word: "遅れます", reading: "おくれます", pitch: 0, meaning: "опоздать", example: "電車が遅れるかもしれません。", exampleMeaning: "Поезд может опоздать." },
    { id: "L32v24", word: "間に合います", reading: "まにあいます", pitch: 0, meaning: "успеть вовремя", example: "走れば、間に合うでしょう。", exampleMeaning: "Если побежишь, наверное, успеешь." },
    { id: "L32v25", word: "約束", reading: "やくそく", pitch: 0, meaning: "обещание; договорённость", example: "約束を守ったほうがいいです。", exampleMeaning: "Тебе лучше сдержать обещание." },
    { id: "L32v26", word: "謝ります", reading: "あやまります", pitch: 4, meaning: "извиняться", example: "早く謝ったほうがいいですよ。", exampleMeaning: "Тебе лучше скорее извиниться." },
    { id: "L32v27", word: "怒ります", reading: "おこります", pitch: 3, meaning: "разозлиться", example: "彼は怒るかもしれません。", exampleMeaning: "Он может разозлиться." },
    { id: "L32v28", word: "落ち込みます", reading: "おちこみます", pitch: 4, meaning: "впасть в уныние", example: "落ち込まないほうがいいですよ。", exampleMeaning: "Тебе лучше не расстраиваться." },
    { id: "L32v29", word: "台風", reading: "たいふう", pitch: 3, meaning: "тайфун", example: "台風が来るかもしれません。", exampleMeaning: "Возможно, придёт тайфун." },
    { id: "L32v30", word: "天気予報", reading: "てんきよほう", pitch: 1, meaning: "прогноз погоды", example: "天気予報によると、雨が降るでしょう。", exampleMeaning: "По прогнозу, вероятно, пойдёт дождь." }
  ],
  grammar: [
    {
      id: "L32g1",
      point: "〜ほうがいいです (тебе лучше / лучше…)",
      explanation: "Утвердительный совет: прошедшая простая форма (た-форма) ＋ ほうがいいです — 休んだほうがいいです. Отрицательный совет: 〜ないほうがいいです — 無理をしないほうがいいです. Это довольно сильная рекомендация, поэтому используй осторожно с вышестоящими.",
      examples: [
        "熱があるなら、病院へ行ったほうがいいですよ。 (Если у тебя температура, лучше сходить к врачу.)",
        "夜遅くコーヒーを飲まないほうがいいです。 (Тебе лучше не пить кофе поздно ночью.)",
        "早く謝ったほうがいいと思います。 (Я думаю, тебе лучше скорее извиниться.)"
      ],
      listening: "Утвердительный совет использует прошедшую た-форму ＋ ほうがいい; отрицательный — 〜ないほうがいい.",
      production: "Дай один совет 'лучше сделать' и один 'лучше не делать'."
    },
    {
      id: "L32g2",
      point: "〜でしょう / 〜かもしれません (наверное / возможно)",
      explanation: "〜でしょう = уверенное предположение ('наверное', ~60–80%). 〜かもしれません = более слабая возможность ('возможно', ~30–50%). Присоединяется к простым формам; na-прил./существительное убирают だ перед でしょう и перед かもしれません (元気でしょう / 雨かもしれません). たぶん часто сочетается с でしょう.",
      examples: [
        "あした晴れるでしょう。 (Завтра, наверное, будет солнечно.)",
        "彼はもう帰ったかもしれません。 (Он, возможно, уже ушёл домой.)",
        "この問題は難しいでしょう。 (Эта задача, наверное, сложная.)"
      ],
      listening: "でしょう = уверенное предположение; かもしれません = более лёгкое 'возможно'.",
      production: "Сделай один прогноз с でしょう и одну возможность с かもしれません."
    }
  ],
  kanji: [
    { id: "L32k1", char: "運", reading: "うん／はこ（ぶ）", meaning: "перевозить; удача", exampleWord: "運動（うんどう）" },
    { id: "L32k2", char: "動", reading: "どう／うご（く）", meaning: "двигаться", exampleWord: "運動（うんどう）" },
    { id: "L32k3", char: "危", reading: "き／あぶ（ない）", meaning: "опасность", exampleWord: "危険（きけん）" },
    { id: "L32k4", char: "険", reading: "けん／けわ（しい）", meaning: "крутой; риск", exampleWord: "危険（きけん）" },
    { id: "L32k5", char: "効", reading: "こう／き（く）", meaning: "эффективный; действовать", exampleWord: "効きます（ききます）" },
    { id: "L32k6", char: "果", reading: "か／は（たす）", meaning: "плод; достигать", exampleWord: "効果（こうか）" },
    { id: "L32k7", char: "変", reading: "へん／か（わる）", meaning: "меняться; странный", exampleWord: "変わります（かわります）" },
    { id: "L32k8", char: "向", reading: "こう／む（かう）", meaning: "лицом; к", exampleWord: "向かいます（むかいます）" }
  ],
  reading: {
    id: "L32r1",
    title: "むりをしないで",
  ...
  questions: [
    { id: "L32q1", dim: "grammar", type: "recall", difficulty: "easy", s: "熱があるなら、休ん___。(лучше отдохнуть)", a: "だほうがいいです", o: ["だほうがいいです", "でほうがいいです", "るほうがいいです", "ないほうがいいです"], c: 0, exp: "Утвердительный совет = прошедшая た-форма ＋ ほうがいい: 休んだほうがいい.", linksTo: "L32g1" },
    { id: "L32q2", dim: "grammar", type: "recall", difficulty: "medium", s: "ここに車を止め___。(лучше не надо)", a: "ないほうがいいです", o: ["たほうがいいです", "ないほうがいいです", "るほうがいいです", "てほうがいいです"], c: 1, exp: "Отрицательный совет = 〜ないほうがいいです.", linksTo: "L32g1" },
    { id: "L32q3", dim: "grammar", type: "recall", difficulty: "medium", s: "あした、晴れる___。(наверное)", a: "でしょう", o: ["かもしれません", "でしょう", "そうです", "ようです"], c: 1, exp: "でしょう = уверенное предположение ('наверное').", linksTo: "L32g2" },
    { id: "L32q4", dim: "grammar", type: "recall", difficulty: "hard", s: "Что является более слабым предположением ('возможно') ?", a: "雨かもしれません", o: ["雨でしょう", "雨かもしれません", "雨です", "雨だ"], c: 1, exp: "かもしれません (~возможно) слабее, чем でしょう (~наверное).", linksTo: "L32g2" },
    { id: "L32q5", dim: "vocab", type: "recognition", difficulty: "easy", s: "倒れます означает…", a: "упасть", o: ["измениться", "упасть", "заниматься спортом", "остановить"], c: 1, exp: "倒れます = упасть / свалиться.", linksTo: "L32v3" },
    { id: "L32q6", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'опасность' ?", a: "危", o: ["運", "動", "危", "険"], c: 2, exp: "危 → 危険（きけん）опасность. (険 = риск/крутой.)", linksTo: "L32k3" },
    { id: "L32q7", dim: "grammar", type: "recall", difficulty: "medium", s: "彼はもう帰った___。(возможно)", a: "かもしれません", o: ["でしょう", "かもしれません", "そうです", "ようです"], c: 1, exp: "かもしれません = более слабая возможность ('возможно').", linksTo: "L32g2" },
    { id: "L32q8", dim: "grammar", type: "recall", difficulty: "hard", s: "元気___。(наверное — na-прил.)", a: "でしょう", o: ["だでしょう", "でしょう", "なでしょう", "のでしょう"], c: 1, exp: "na-прил./существительное убирают だ перед でしょう: 元気でしょう.", linksTo: "L32g2" },
    { id: "L32q9", dim: "vocab", type: "recognition", difficulty: "easy", s: "薬 означает…", a: "лекарство", o: ["температура", "лекарство", "травма", "эффект"], c: 1, exp: "薬 (くすり) = лекарство.", linksTo: "L32v12" },
    { id: "L32q10", dim: "vocab", type: "recognition", difficulty: "medium", s: "謝ります означает…", a: "извиняться", o: ["беспокоиться", "извиняться", "злиться", "опаздывать"], c: 1, exp: "謝ります (あやまります) = извиняться.", linksTo: "L32v26" },
    { id: "L32q11", dim: "vocab", type: "recall", difficulty: "medium", s: "熱が___なら、休んだほうがいいです。(температура)", a: "ある", o: ["ある", "いる", "する", "とる"], c: 0, exp: "熱がある = иметь температуру.", linksTo: "L32v14" },
    { id: "L32q12", dim: "kanji", type: "recognition", difficulty: "medium", s: "Какой кандзи означает 'эффективный / действовать' ?", a: "効", o: ["運", "動", "効", "向"], c: 2, exp: "効 → 効きます (быть эффективным).", linksTo: "L32k5" }
  ]
},
